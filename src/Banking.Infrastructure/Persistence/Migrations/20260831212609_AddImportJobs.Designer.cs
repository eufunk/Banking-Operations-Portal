...
namespace Banking.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260831212609_AddImportJobs")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Banking.Domain.Imports.ImportJob", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Banking.Domain.Imports.ImportRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ImportRecords", (string)null);
                });
            ...
            modelBuilder.Entity("Banking.Domain.Imports.ImportRecord", b =>
                {
                    b.HasOne("Banking.Domain.Imports.ImportJob", null)
                        .WithMany("Records")
